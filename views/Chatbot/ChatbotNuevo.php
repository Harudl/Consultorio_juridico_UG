...
<form id="formulario" action="index.php?c=Chatbot&a=crear_nuevo"  onsubmit="return chatbot_p()" method="post" enctype="multipart/form-data">
  <div class="formularios">
      <div class="containerForm">
        <div class="formItem" style="grid-template-columns: repeat(auto-fit, minmax(400px,1fr ));">
          <div class="form-box">
            <label for="Pregunta">Pregunta</label>
           <!--  <input type="text" name="nomnbre_personal" id="nomnbre_personal" placeholder="Digite apellidos y nombres"> -->
      ...
      <div class="form-box">
           ...
           <textarea name="Respuesta" id="Respuesta" cols="10" rows="5"></textarea>
           <span></span>
          </div>
